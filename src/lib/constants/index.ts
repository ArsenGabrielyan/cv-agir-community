...
export const AUDIT_QUICK_FILTERS: Record<QuickFilterType,AuditAction[]> = {
     ...
     template: ["TEMPLATE_CREATED","TEMPLATE_UPDATED","TEMPLATE_DELETED","TEMPLATE_BULK_DELETE"],
     category: ["CATEGORY_CREATED","CATEGORY_UPDATED","CATEGORY_DELETED","CATEGORY_BULK_DELETE"],
}
